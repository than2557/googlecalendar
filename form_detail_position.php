...
var  detail_position_name = document.getElementById("detail_position_name").value;
console.log(id_position);
console.log(detail_position_name);
$.ajax({
type:"POST",
url:"insert_position_detail.php",
data:{"id_position":id_position,"detail_position_name":detail_position_name},
...
<label>แผนก</label>
    ...
    <label>ฝ่าย</label>
    <input name="detail_position_name" id="detail_position_name">
