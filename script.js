    ...
    function calendarController($scope) {
        ...
        function showDays(days) {
            for (var i = 1; i < days; i++) {
                ...
                $(".dates").append("<span  id='dateselect' class='date_item' data='" + uidi + "' >" + i + "</span>");
...
function sentcalendar() {
    ...
    $.ajax({
        type: "POST",
        url: "quickstart.php",
        data: { "date": date, "event": event, "start": start, "end": end, "enddate": enddate, "time_period": time_period, "room_id": room_id },
